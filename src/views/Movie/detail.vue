<template>
	<div id="detailContent" class="slide-active">
		<Header title="影片详情">
...
<style scoped>
#detailContent{position:absolute;top:0;left:0;z-index:100;width:100%;min-height:100%;background:white;}
#detailContent.slide-active{animation: .3s slidemove}
@keyframes slidemove{
...
.detail_player .swiper-slide div{width:70px;height:48px;}
.detail_player .swiper-slide div img{ width:100%;height: 100%; margin-bottom: 5px;}
